create table acl_data (n int4 not null primary key, acl ace_int4[]);
...
from generate_series(0, $unique_aces - 1) g1
  cross join lateral (
    select array_agg((t.type || '//' || ((random() * g1 * g2)::int4 % 100) || '=' || a.rights)::ace_int4) as acl
